...
import { Bell, BookmarkCheck, Calendar, FileText, Hospital, LayoutDashboard, LogOut, MapPin, MessageSquare, Settings, User, Users, X } from 'lucide-react';
...
const patientNavigation: NavigationItem[] = [
    ...
    { icon: MapPin, label: 'My Family', path: '/patient/family-list' },
